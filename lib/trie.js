(function() {
  ...
  toCodePoints = function(str) {
    var counter, extra, length, result, value;
    str = String(str);
    result = [];
    counter = 0;
    length = str.length;
  ...
  TernarySearchTrie = (function() {
    ...
    TernarySearchTrie.prototype.set = function(key, value, debug) {
      var codepoints;
    ...
    TernarySearchTrie.prototype.del = function(key) {
      ...
      codepoints = toCodePoints(key);
      this.delete_(this.root_, codepoints, 0);
      return this;
    };

    TernarySearchTrie.prototype.delete_ = function(root, codepoints, index) {
      var branch, c, child, isEqual, node, parent;
      while ((root != null) && index < codepoints.length) {
        c = codepoints[index];
        branch = (function() {
          switch (false) {
